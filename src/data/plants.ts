...
export const PLANTS_DATA: PlantSpecimen[] = [
  {
    ...
    tree: false,
    badge: 'Bestseller',
    climateTag: 'Coastal Airflow Lover',
    zoneMatchPercent: {
      '10a': 98,
      '9b': 94,
      '8a': 82,
    ...
    sizes: [
      { id: 'sm', name: 'Small', potDiameter: '4" Nursery Pot', priceDelta: -830 },
      { id: 'md', name: 'Medium', potDiameter: '6" Matte Pot', priceDelta: 0 },
      { id: 'lg', name: 'Large', potDiameter: '10" Floor Vessel', priceDelta: 1992 },
      { id: 'xl', name: 'Extra Large', potDiameter: '14" Statement Planter', priceDelta: 4316 },
    ],
    vessels: [
      { id: 'sage', name: 'Matte Sage', colorHex: '#74c69d', priceDelta: 0 },
      { id: 'terracotta', name: 'Warm Terracotta', colorHex: '#c86d51', priceDelta: 332 },
      { id: 'sand', name: 'Sand Ceramic', colorHex: '#d8cfbc', priceDelta: 498 },
      { id: 'linen', name: 'Linen Glaze', colorHex: '#edeae1', priceDelta: 664 },
    ],
  },
  {
    id: 'staghorn-fern',
    ...
    sizes: [
      ...
      { id: 'md', name: 'Mounted 10"', potDiameter: 'Reclaimed Plank', priceDelta: 1494 },
    ],
    vessels: [
      { id: 'cedar', name: 'Reclaimed Cedar', colorHex: '#8b5a2b', priceDelta: 0 },
      { id: 'sage-plaque', name: 'Sage Slate', colorHex: '#4a6b57', priceDelta: 498 },
    ],
  },
  {
    id: 'maidenhair-fern',
    ...
    care: {
      ...
      temperature: '14°C – 24°C (58°F – 75°F)',
      difficulty: 'Expert',
      difficultyDrops: 3,
    ...
    sizes: [
      ...
      { id: 'md', name: 'Lush 6"', potDiameter: '6" Terracotta', priceDelta: 996 },
    ],
    vessels: [
      { id: 'terracotta', name: 'Terracotta Saucer', colorHex: '#c86d51', priceDelta: 0 },
      { id: 'sand', name: 'Sand Ceramic', colorHex: '#d8cfbc', priceDelta: 332 },
    ],
  },
  {
    ...
    sizes: [
      ...
      { id: 'lg', name: 'Climbing 8" (Moss Pole)', potDiameter: '8" Vessel with Pole', priceDelta: 1660 },
    ],
    vessels: [
      { id: 'sage', name: 'Matte Sage', colorHex: '#74c69d', priceDelta: 0 },
      { id: 'sand', name: 'Sand Ceramic', colorHex: '#d8cfbc', priceDelta: 415 },
    ],
  },
  {
    id: 'fiddle-leaf-fig',
    ...
    care: {
      ...
      temperature: '18°C – 26°C (65°F – 78°F)',
      difficulty: 'Moderate',
      difficultyDrops: 2,
    ...
    sizes: [
      ...
      { id: 'xl', name: 'Specimen Tree (5-6 ft)', potDiameter: '14" Estate Planter', priceDelta: 3735 },
    ],
    vessels: [
      { id: 'sand', name: 'Sand Ceramic', colorHex: '#d8cfbc', priceDelta: 0 },
      { id: 'terracotta', name: 'Terracotta', colorHex: '#c86d51', priceDelta: 830 },
      { id: 'sage', name: 'Matte Sage', colorHex: '#74c69d', priceDelta: 996 },
    ],
  },
  {
    ...
    sizes: [
      ...
      { id: 'lg', name: 'Full 8"', potDiameter: '8" Cylinder Vessel', priceDelta: 1328 },
    ],
    vessels: [
      { id: 'linen', name: 'Linen Glaze', colorHex: '#edeae1', priceDelta: 0 },
      { id: 'sage', name: 'Matte Sage', colorHex: '#74c69d', priceDelta: 415 },
    ],
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1598880940080-ff9a29891b85?auto=format&fit=crop&w=800&q=80',
    additionalImages: [
    ...
    care: {
      ...
      temperature: '13°C – 32°C (55°F – 90°F)',
      difficulty: 'Beginner',
      difficultyDrops: 1,
      toxicity: 'Mildly toxic if ingested by pets.',
    },
    sizes: [
      { id: 'sm', name: 'Desk 4"', potDiameter: '4" Cylinder', priceDelta: -664 },
      { id: 'md', name: 'Medium 6"', potDiameter: '6" Matte Pot', priceDelta: 0 },
      { id: 'lg', name: 'Floor 10"', potDiameter: '10" Tall Vessel', priceDelta: 1826 },
    ],
    vessels: [
      { id: 'sage', name: 'Matte Sage', colorHex: '#74c69d', priceDelta: 0 },
      { id: 'terracotta', name: 'Terracotta', colorHex: '#c86d51', priceDelta: 332 },
      { id: 'sand', name: 'Sand Ceramic', colorHex: '#d8cfbc', priceDelta: 498 },
    ],
  },
  {
    ...
    sizes: [
      ...
      { id: 'xl', name: 'Estate Specimen (5-6 ft)', potDiameter: '14" Terracotta Urn', priceDelta: 4565 },
    ],
    vessels: [
      { id: 'terracotta', name: 'Raw Terracotta Urn', colorHex: '#c86d51', priceDelta: 0 },
      { id: 'sand', name: 'Sand Ceramic', colorHex: '#d8cfbc', priceDelta: 996 },
    ],
  },
];

export const GROWING_ZONES = [
  { zone: '13a', name: 'Zone 13a (15°C to 18°C)', city: 'Mumbai, MH', zip: '400001', desc: 'Hot coastal monsoon humidity, Arabian Sea breeze, year-round warmth' },
  { zone: '10a', name: 'Zone 10a (-1°C to 2°C)', city: 'Delhi, DL', zip: '110001', desc: 'Subtropical continental heat, cool winter nights, monsoon rains' },
  { zone: '12a', name: 'Zone 12a (10°C to 13°C)', city: 'Bengaluru, KA', zip: '560001', desc: 'Deccan plateau garden city, mild winters, moderate monsoon showers' },
  { zone: '13b', name: 'Zone 13b (18°C to 21°C)', city: 'Chennai, TN', zip: '600001', desc: 'Tropical Coromandel warmth, humid sea breeze, lush year-round growth' },
  { zone: '11a', name: 'Zone 11a (4°C to 7°C)', city: 'Jaipur, RJ', zip: '302001', desc: 'Arid desert edge, hot dry summers, bright winter sunshine' },
  { zone: '8a', name: 'Zone 8a (-9°C to -7°C)', city: 'Shimla, HP', zip: '171001', desc: 'Himalayan foothill chill; give plants winter indoor warmth' },
];
